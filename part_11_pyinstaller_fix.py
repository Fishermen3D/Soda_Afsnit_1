...
box_shadow = pygame.image.load("graphics/box_shadow.png").convert_alpha()
bottle_shadow = pygame.image.load("graphics/bottle_shadow.png").convert_alpha()
...
background_music = pygame.mixer.Sound("sound/bg_music.mp3")
...
while game_is_running:
    ...
    if not game_over:
        ...
        window.blit(box_shadow, (box_position_x, box_position_y + 90))
        window.blit(bottle_shadow, (bottle_position_x, window_height - 90))
